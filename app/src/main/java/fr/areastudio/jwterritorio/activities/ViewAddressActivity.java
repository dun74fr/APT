...
public class ViewAddressActivity extends AppCompatActivity {
    ...
    private void initView(final long address_id) {
        ...
        visit.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                new AlertDialog.Builder(ViewAddressActivity.this).setMessage(R.string.confirm_type_change).setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        visitIgnore = true;
                        visit.setChecked(!visit.isChecked());
                        visitIgnore = false;
                    }
                }).create().show();
            }
        ...
        notAtHome.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (notAtHomeIgnore){
                    return;
                ...
                new AlertDialog.Builder(ViewAddressActivity.this).setMessage(R.string.confirm_type_change).setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        notAtHomeIgnore = true;
                        notAtHome.setChecked(!notAtHome.isChecked());
                        notAtHomeIgnore = false;
                    }
                }).create().show();
            }
        });
        type_phone.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (type_phoneIgnore){
                    return;
                ...
                new AlertDialog.Builder(ViewAddressActivity.this).setMessage(R.string.confirm_type_change).setPositiveButton(R.string.action_ok, new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        type_phoneIgnore = true;
                        type_phone.setChecked(!type_phone.isChecked());
                        type_phoneIgnore = false;
                    }
                }).create().show();
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        this.menu = menu;
        if (address == null || (!"DRAFT".equals(address.status) && !"VALIDATE".equals(address.status)) ){
